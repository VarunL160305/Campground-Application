module.exports = [
  // 🇮🇳 INDIA
  { city: "Taj Mahal", latitude: 27.1751, longitude: 78.0421, state: "India" },
  { city: "Mumbai", latitude: 19.0760, longitude: 72.8777, state: "India" },
  { city: "Delhi", latitude: 28.6139, longitude: 77.2090, state: "India" },
  { city: "Jaipur", latitude: 26.9124, longitude: 75.7873, state: "India" },

  // 🇦🇪 UAE
  { city: "Burj Khalifa", latitude: 25.1972, longitude: 55.2744, state: "UAE" },
  { city: "Dubai", latitude: 25.2048, longitude: 55.2708, state: "UAE" },

  // 🇯🇵 JAPAN
  { city: "Tokyo", latitude: 35.6762, longitude: 139.6503, state: "Japan" },
  { city: "Mount Fuji", latitude: 35.3606, longitude: 138.7274, state: "Japan" },

  // 🇨🇳 CHINA
  { city: "Great Wall of China", latitude: 40.4319, longitude: 116.5704, state: "China" },
  { city: "Beijing", latitude: 39.9042, longitude: 116.4074, state: "China" },

  // 🇹🇭 THAILAND
  { city: "Bangkok", latitude: 13.7563, longitude: 100.5018, state: "Thailand" },
  { city: "Phuket", latitude: 7.8804, longitude: 98.3923, state: "Thailand" },

  // 🇸🇬 SINGAPORE
  { city: "Marina Bay Sands", latitude: 1.2834, longitude: 103.8607, state: "Singapore" },

  // 🇫🇷 FRANCE
  { city: "Eiffel Tower", latitude: 48.8584, longitude: 2.2945, state: "France" },
  { city: "Paris", latitude: 48.8566, longitude: 2.3522, state: "France" },

  // 🇮🇹 ITALY
  { city: "Colosseum", latitude: 41.8902, longitude: 12.4922, state: "Italy" },
  { city: "Venice", latitude: 45.4408, longitude: 12.3155, state: "Italy" },

  // 🇬🇧 UK
  { city: "London", latitude: 51.5074, longitude: -0.1278, state: "UK" },
  { city: "Big Ben", latitude: 51.5007, longitude: -0.1246, state: "UK" },

  // 🇪🇸 SPAIN
  { city: "Barcelona", latitude: 41.3851, longitude: 2.1734, state: "Spain" },
  { city: "Madrid", latitude: 40.4168, longitude: -3.7038, state: "Spain" },

  // 🇨🇭 SWITZERLAND
  { city: "Swiss Alps", latitude: 46.8182, longitude: 8.2275, state: "Switzerland" },

  // 🇹🇷 TURKEY
  { city: "Istanbul", latitude: 41.0082, longitude: 28.9784, state: "Turkey" },

  // 🇷🇺 RUSSIA
  { city: "Moscow", latitude: 55.7558, longitude: 37.6173, state: "Russia" },

  // 🇬🇷 GREECE
  { city: "Santorini", latitude: 36.3932, longitude: 25.4615, state: "Greece" },

  // 🇩🇪 GERMANY
  { city: "Berlin", latitude: 52.5200, longitude: 13.4050, state: "Germany" },
    {
        city: "Plano",
